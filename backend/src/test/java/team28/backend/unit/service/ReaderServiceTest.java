...
public class ReaderServiceTest {
     ...
     * @Test
     * public void
     * givenReaderInfo_whenReaderIsBeingCreated_thenReaderIsAddedToDatabase() {
     * Coordinate coordinate = new Coordinate(10,
     * 20);
     * when(CoordinateRepository.save(any(Coordinate.class))).thenReturn(coordinate)
     * ;
     * 
     * ReaderInput ReaderInput = new ReaderInput(reader.getMacAddress(),
     * reader.getName(), coordinate);
